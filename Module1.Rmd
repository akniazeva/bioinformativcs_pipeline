...
library(pathfindR)
#package for visualisation of pathway enrichment data
#library(enrichplot)
#library(GOplot)

#package for GO clustering
library(GO.db)
...
#Lypid, gycolisis and amino acid genes related to metabolism from GO.terms for pathway selection in pathfindR
all.lypid.genes.GO <- read.csv("C:/Users/acer/Desktop/GO_term_summary_metabolic_lypid.csv", fileEncoding = "UTF-16")

all.glyco.genes.GO <- read.csv("C:/Users/acer/Desktop/GO_term_summary_metabolic glyco.csv", fileEncoding = "UTF-16")

all.amino.acid.genes.GO <- read.csv("C:/Users/acer/Desktop/GO_term_summary_metabolic_amino_acid.csv", fileEncoding = "UTF-16")
...
cells.to.remove <- c("GCB.1","GCB.2","SplPlsB.1" ,
                      ...
                      "MegTPO.1",  "MegTPO.2", 
                      "B1Pt.1", "B1Pt.2", "BMPlsC.1", "Fob.1",                       
                      "Fob.2", "GCB.1", "GCB.2", "MZB.1",                           
                      "MZB.2", "PtB.1", "PtB.2", "SplPlsB.1",
                      "SplPlsC.1", "SplPlsC.2", "SplPlsC.3", 
                      "NK.1", "NK.2", "CLP.1", "CLP.2", 
                      "GMP_IRF8hi.1", "GMP_IRF8hi.2",
                      "GMP_IRF8lo.1", "GMP_IRF8lo.2",
                      "CD4T.1", "CD4T.2", "CD8T.1", "CD8T.2",
                      "NveCD4T.1", "NveCD4T.2", "NveCd8T.1",
                      "NveCd8T.2", "RegT.1", "RegT.2")
...
E.immuno.heatmap <- coolmap(v[genes.E.immuno,], cexRow=0.5, cexCol=0.5)
...
#create dataset of pathways with related genes
output.test.all.genes <- run_pathfindR(test.dataset.M.go, gene_sets = "GO-All", p_val_threshold = 0.05, max_gset_size = 9000, max_to_plot = 100, adj_method = "bonferroni", output_dir = "C:/Users/acer/Desktop/pathfindeR results" )
